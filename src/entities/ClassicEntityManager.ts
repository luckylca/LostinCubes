...
const MAXIMUM_HOSTILES = 24;
const MAXIMUM_PASSIVES = 12;
const HOSTILE_SPAWN_INTERVAL = 1.25;
const PASSIVE_SPAWN_INTERVAL = 3.5;
const MINIMUM_SPAWN_RADIUS = 12;
const MAXIMUM_SPAWN_RADIUS = 26;
