...
const DEFINITIONS: Readonly<Record<ItemType, ItemDefinition>> = {
  [ItemType.GrassBlock]: blockDefinition(
    '草方块',
    'grass',
    BlockType.Grass,
    [0.38, 0.61, 0.24],
  ),
  [ItemType.DirtBlock]: blockDefinition(
    '泥土',
    'dirt',
    BlockType.Dirt,
    [0.48, 0.32, 0.2],
  ),
  [ItemType.StoneBlock]: blockDefinition(
    '石头',
    'stone',
    BlockType.Stone,
    [0.53, 0.55, 0.54],
  ),
  [ItemType.CobblestoneBlock]: blockDefinition(
    '圆石',
    'cobblestone',
  ...
  [ItemType.CoalOreBlock]: blockDefinition(
    '煤矿石',
    'coal-ore',
    BlockType.CoalOre,
    [0.25, 0.26, 0.26],
  ),
  [ItemType.IronOreBlock]: blockDefinition(
    '铁矿石',
    'iron-ore',
    BlockType.IronOre,
    [0.58, 0.43, 0.33],
  ),
  [ItemType.FurnaceBlock]: blockDefinition(
    '熔炉',
    'furnace',
    BlockType.Furnace,
    [0.38, 0.4, 0.39],
  ),
  [ItemType.TorchBlock]: blockDefinition(
    '火把',
    'torch',
    BlockType.Torch,
    [0.93, 0.66, 0.23],
  ),
  [ItemType.SandBlock]: blockDefinition(
    '沙子',
    'sand',
    BlockType.Sand,
    [0.82, 0.76, 0.51],
  ),
  [ItemType.GravelBlock]: blockDefinition(
    '沙砾',
    'gravel',
    BlockType.Gravel,
    [0.48, 0.46, 0.45],
  ),
  [ItemType.ClayBlock]: blockDefinition(
    '黏土块',
    'clay',
    BlockType.Clay,
    [0.58, 0.64, 0.67],
  ),
  [ItemType.SnowBlock]: blockDefinition(
    '雪块',
    'snow',
    BlockType.Snow,
    [0.92, 0.96, 0.98],
  ),
  [ItemType.LadderBlock]: blockDefinition(
    '梯子',
    'ladder',
    BlockType.Ladder,
    [0.58, 0.39, 0.18],
  ...
  [ItemType.OakSaplingBlock]: blockDefinition(
    '橡树树苗',
    'oak-sapling',
    BlockType.OakSapling,
    [0.25, 0.55, 0.18],
  ),
  [ItemType.TallGrassBlock]: blockDefinition(
    '高草',
    'tall-grass',
    BlockType.TallGrass,
    [0.27, 0.57, 0.2],
  ),
  [ItemType.DandelionBlock]: blockDefinition(
    '蒲公英',
    'dandelion',
    BlockType.Dandelion,
    [0.84, 0.7, 0.15],
  ),
  [ItemType.Stick]: materialDefinition(
    '木棍',
    'stick',
    [0.57, 0.39, 0.2],
    0.5,
  ...
  [ItemType.RawIron]: materialDefinition(
    '粗铁',
    'raw-iron',
    [0.61, 0.42, 0.3],
  ),
  [ItemType.IronIngot]: materialDefinition(
    '铁锭',
    'iron-ingot',
    [0.77, 0.79, 0.77],
  ),
  ...
  [ItemType.IronShovel]: toolDefinition(
    '铁铲',
    'iron-shovel',
    'shovel',
    'iron',
  ...
  [ItemType.IronPickaxe]: toolDefinition(
    '铁镐',
    'iron-pickaxe',
    'pickaxe',
    'iron',
  ...
  [ItemType.IronAxe]: toolDefinition(
    '铁斧',
    'iron-axe',
    'axe',
    'iron',
...
export function getMiningSpeedMultiplier(
  ...
  if (
    blockDefinition.renderShape === 'cross' ||
